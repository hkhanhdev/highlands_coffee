...
TABLE = "products"
TABLE_TYPE = "sm"
TABLE_IDENTIFIER = ("raw_test", "products") #logical table identifier in Iceberg catalog
TABLE_LOCATION = "s3://highlands-coffee-warehouse/raw_test/products" #physical location in MinIO bucket
...
def main():
    ...
    # catalog.drop_table(("raw_test", "products"))
    # table = catalog.load_table(("raw_test", "products"))
    # print(table.schema())
    print("Products module executed")
