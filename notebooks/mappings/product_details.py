...
TABLE_TYPE = "sm"
TABLE_IDENTIFIER = ("raw_test", "product_details") #logical table identifier in Iceberg catalog
TABLE_LOCATION = "s3://highlands-coffee-warehouse/raw_test/product_details" #physical location in MinIO bucket
# Create output schema
SCHEMA = Schema(
    NestedField(1, "id", LongType(), required=False),
    NestedField(2, "product_id", LongType(), required=False),
    NestedField(3, "size", StringType(), required=False),
    NestedField(4, "price", LongType(), required=False),
)
