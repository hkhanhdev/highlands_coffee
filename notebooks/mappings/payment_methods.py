...
TABLE_TYPE = "sm"
TABLE_IDENTIFIER = ("raw_test", "payment_methods") #logical table identifier in Iceberg catalog
TABLE_LOCATION = "s3://highlands-coffee-warehouse/raw_test/payment_methods" #physical location in MinIO bucket
...
def main():
    ...
    # catalog.drop_table(("raw_test", "payment_methods"))
    # table = catalog.load_table(("raw_test", "payment_methods"))
    # print(table.schema())

    print("Payment Methods module executed")
