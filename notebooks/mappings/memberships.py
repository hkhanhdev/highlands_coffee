...
TABLE = "memberships"
TABLE_TYPE = "sm"
TABLE_IDENTIFIER = ("raw_test", "memberships") #logical table identifier in Iceberg catalog
TABLE_LOCATION = "s3://highlands-coffee-warehouse/raw_test/memberships" #physical location in MinIO bucket
# Create output schema
SCHEMA = Schema(
    NestedField(1, "id", LongType(), required=False),
    NestedField(2, "membership_name", StringType(), required=False),
)
...
def main():
    ...
    # catalog.drop_table(("raw_test", "memberships"))
    # table = catalog.load_table(("raw_test", "memberships"))
    # print(table.schema())

    print("Memberships module executed")
